...
<section class="h-screen bg-[#2E3041] text-white">
    <div class="w-screen h-full">
        <div class="grid-cols-1 lg:grid-cols-2 justify-center items-center h-full w-screen grid">
            ...
            <div class="mx-auto md:w-1/2 xl:w-1/3">
                ...
                <form method="POST" action="{$home_url}login.php">
                    ...
                    <div class="flex justify-between items-center flex-col lg:flex-row mb-6">
